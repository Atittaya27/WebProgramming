...
function page_header($title, $bgcolor = "ffffff") {
    echo '<html><head><title>' . $title . '</title></head>'; // Fixed the head tag
...
// Check if num1 and num2 are set
if (isset($_GET['num1']) && isset($_GET['num2'])) {
    $n1 = intval($_GET['num1']);
    $n2 = intval($_GET['num2']);
    $result = summation($n1, $n2); // Call summation function
    show_form();
    echo '<hr>';
